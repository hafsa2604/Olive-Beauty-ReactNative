        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <GlassCard style={styles.card}>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.bodyText}>
                All payments processed through our platform utilize bank-grade 256-bit SSL encryption. Olive Beauty does not store full credit card credentials on our servers.
              </Text>
            </View>
